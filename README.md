...
[![Version](https://img.shields.io/badge/version-1.3.0-4F98A3?style=flat-square&labelColor=12110e)](https://github.com/paulfxyz/junk/releases/latest)
...
2. Download the right `.dmg` for your Mac:
   - **Apple Silicon (M1 / M2 / M3 / M4)** → `Junk-1.3.0-arm64.dmg`
   - **Intel Mac** → `Junk-1.3.0-x64.dmg`
...
# Build DMG
npm run build
# → dist/Junk-1.3.0-arm64.dmg
# → dist/Junk-1.3.0-x64.dmg
```
