...
[![Version](https://img.shields.io/badge/version-3.1.6-5b5bf6?style=flat-square)](https://github.com/paulfxyz/junk/releases)
...
| **Dim on blur** | Fades to 50% opacity when you switch to another app — stays visible but unobtrusive. Uses `NSWindow.setAlphaValue` on macOS, `SetLayeredWindowAttributes` on Windows, CSS inline opacity on Linux. Toggleable in Preferences. |
...
1. Download **`Junk_3.1.6_universal.dmg`** from [Releases](https://github.com/paulfxyz/junk/releases)
...
1. Download **`Junk_3.1.6_x64-setup.exe`** from [Releases](https://github.com/paulfxyz/junk/releases)
...
```
msiexec /i Junk_3.1.6_x64_en-US.msi /quiet
```
...
```sh
wget https://github.com/paulfxyz/junk/releases/latest/download/Junk_3.1.6_amd64.AppImage
chmod +x Junk_3.1.6_amd64.AppImage
./Junk_3.1.6_amd64.AppImage
```
...
```sh
wget https://github.com/paulfxyz/junk/releases/latest/download/Junk_3.1.6_amd64.deb
sudo dpkg -i Junk_3.1.6_amd64.deb
junk
```
...
| Runner | Artifacts |
|---|---|
| macOS | `Junk_3.1.6_universal.dmg` |
| Windows | `Junk_3.1.6_x64-setup.exe` + `Junk_3.1.6_x64_en-US.msi` |
| Ubuntu | `Junk_3.1.6_amd64.AppImage` + `Junk_3.1.6_amd64.deb` |
