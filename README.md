...
Alternatively, download the **MSI** (`Junk_2.7.1_x64_en-US.msi`) for enterprise/silent deployment:
...
Tag pushed (e.g. v2.3.0)
        ...
        │                    → Junk_2.7.1_universal.dmg
        │
        ├─ [Windows runner]  npm ci
        │                    npm run tauri build
        │                    → Junk_2.7.1_x64-setup.exe
        │                    → Junk_2.7.1_x64_en-US.msi
        │
        └─ [Ubuntu runner]   npm ci
                             apt-get install libwebkit2gtk-4.1-dev ...
                             npm run tauri build
                             → Junk_2.7.1_amd64.AppImage
                             → Junk_2.7.1_amd64.deb
                                      │
                                      ▼
